...
var ListResumePageModule = /** @class */ (function () {
    function ListResumePageModule() {
    }
...
var ListResumePage = /** @class */ (function () {
    function ListResumePage(modalController) {
        this.modalController = modalController;
        this.order = undefined;
    }
    ListResumePage.prototype.ngOnInit = function () {
        var _this = this;
        this.subscribe = _eventemitter_eventemitter_service__WEBPACK_IMPORTED_MODULE_2__["EventEmitterService"].get('listOrderData').subscribe(function (data) {
            _this.order = data;
            console.log(_this.order);
        });
        _eventemitter_eventemitter_service__WEBPACK_IMPORTED_MODULE_2__["EventEmitterService"].get('requestOrderData').emit();
    };
    ListResumePage.prototype.ngOnDestroy = function () {
        this.subscribe.unsubscribe();
    };
    ListResumePage.prototype.expandOperation = function (item) {
        item.operation_expanded = !item.operation_expanded;
    };
    ListResumePage.prototype.expandComponent = function (item) {
        this.presentModal(item);
    };
    ListResumePage.prototype.presentModal = function (data) {
    ...
    ListResumePage.ctorParameters = function () { return [
...
//# sourceMappingURL=listresume-listresume-module-es5.js.map