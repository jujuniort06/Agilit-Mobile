...
let ListassignaturePageModule = class ListassignaturePageModule {
};
...
let ListAssignaturePage = class ListAssignaturePage {
    constructor() {
    ...
    ngOnInit() {
        _eventemitter_eventemitter_service__WEBPACK_IMPORTED_MODULE_2__["EventEmitterService"].get('listOrderData').subscribe((data) => {
            this.order = data;
...
//# sourceMappingURL=listassignature-listassignature-module-es2015.js.map