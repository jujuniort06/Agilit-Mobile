...
var DefaultOperationPageModule = /** @class */ (function () {
    function DefaultOperationPageModule() {
    }
    ...
    return DefaultOperationPageModule;
}());
...
var DefaultOperationPage = /** @class */ (function () {
    function DefaultOperationPage(modalController, changeDetectorRef) {
        this.modalController = modalController;
        this.changeDetectorRef = changeDetectorRef;
        this.order = undefined;
    }
    DefaultOperationPage.prototype.ngOnInit = function () {
        var _this = this;
        this.subscribe = _eventemitter_eventemitter_service__WEBPACK_IMPORTED_MODULE_4__["EventEmitterService"].get('defaultOrderData').subscribe(function (data) {
            _this.order = data;
        });
        _eventemitter_eventemitter_service__WEBPACK_IMPORTED_MODULE_4__["EventEmitterService"].get('requestOrderData').emit();
    };
    DefaultOperationPage.prototype.ngOnDestroy = function () {
        this.subscribe.unsubscribe();
    };
    DefaultOperationPage.prototype.expandedItem = function (item) {
        item.expanded = !item.expanded;
    };
    DefaultOperationPage.prototype.addOperation = function () {
        this.presentModal();
    };
    DefaultOperationPage.prototype.presentModal = function () {
    ...
    DefaultOperationPage.ctorParameters = function () { return [
...
//# sourceMappingURL=defaultoperation-defaultoperation-module-es5.js.map