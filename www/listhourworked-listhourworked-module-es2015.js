...
let ListHourworkedPageModule = class ListHourworkedPageModule {
};
...
let ListHourworkedPage = class ListHourworkedPage {
    ...
    ngOnInit() {
        _eventemitter_eventemitter_service__WEBPACK_IMPORTED_MODULE_3__["EventEmitterService"].get('listOrderData').subscribe((data) => {
            this.order = data;
...
ListHourworkedPage.ctorParameters = () => [
...
//# sourceMappingURL=listhourworked-listhourworked-module-es2015.js.map