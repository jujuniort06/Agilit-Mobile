...
var DefaultHourWorkedPageModule = /** @class */ (function () {
    function DefaultHourWorkedPageModule() {
    }
    ...
    return DefaultHourWorkedPageModule;
}());
...
var DefaultHourWorkedPage = /** @class */ (function () {
    function DefaultHourWorkedPage(viewUtils) {
        this.viewUtils = viewUtils;
        this.order = undefined;
        this.hoursAponted = [];
        this.initializingObject();
    }
    DefaultHourWorkedPage.prototype.ngOnInit = function () {
        var _this = this;
        this.subscribe = _eventemitter_eventemitter_service__WEBPACK_IMPORTED_MODULE_3__["EventEmitterService"].get('defaultOrderData').subscribe(function (data) {
            _this.order = data;
        });
    };
    DefaultHourWorkedPage.prototype.ngOnDestroy = function () {
        this.subscribe.unsubscribe();
    };
    DefaultHourWorkedPage.prototype.confirmAppointments = function () {
        var hourAponted = {};
    ...
    DefaultHourWorkedPage.prototype.initializingObject = function () {
    };
    DefaultHourWorkedPage.ctorParameters = function () { return [
...
//# sourceMappingURL=defaulthourworked-defaulthourworked-module-es5.js.map